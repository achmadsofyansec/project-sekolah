                        ...
                        <form action="{{route('perizinan.store')}}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_izin" id="tgl_izin" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Siswa</label>
                                ...
                                <div class="form-group">
                                    <label>Alasan</label>
                                    <textarea name="keterangan_izin" id="keterangan_izin" cols="30" rows="8" placeholder="Alasan" class="form-control" required></textarea>
                                </div>
                            </div>
                            <div class="card-footer">
