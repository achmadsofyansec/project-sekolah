  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link font-weight-normal" href="{{route('pengumuman')}}">Home</a>
      </li>
      <li class="nav-item">
        <a class="nav-link font-weight-normal text-success" href="{{route('portal')}}">Portal Pendaftaran <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
