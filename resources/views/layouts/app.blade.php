...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-pink elevation-4">
    ...
    <a href="<?php echo url('/') ?>" class="brand-link">
      <img src="{{asset('public/dist/img/jamanu_logo.png')}}" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('public/dist/img/jamanu_logo.png')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo url('/alumni') ?>" class="nav-link">
              <i class="nav-icon fas fa-user-graduate text-danger"></i>
              <p>
               Data Aumni
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-people-carry text-primary"></i>
              <p>
               Bursa Kerja
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo url('/lowongan') ?>" class="nav-link">
                  <i class="fas fa-angle-right nav-icon text-success"></i>
                  <p>Lowongan Kerja</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo url('/konfirmasi') ?>" class="nav-link">
                  <i class="fas fa-angle-right nav-icon text-pink"></i>
          ...
          <li class="nav-item">
            <a href="<?php echo url('/pengumuman') ?>" class="nav-link">
              <i class="nav-icon fas fa-paste text-success"></i>
              <p>
               Data Pengumuman
              </p>
            </a>
          </li>
          <li class="nav-header">Lain Lainnya</li>
          <li class="nav-item">
            <a href="<?php echo url('/laporan') ?>" class="nav-link">
