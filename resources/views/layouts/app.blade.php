        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-compass text-primary"></i>
              <p>
                Data Master
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo url('/jenis_dokumen') ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?php echo url('/lemari') ?>" class="nav-link">
                  <i class="fas fa-angle-right nav-icon text-primary"></i>
                  <p>Lemari</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo url('/rak') ?>" class="nav-link">
                  <i class="fas fa-angle-right nav-icon text-primary"></i>
                  <p>Rak</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo url('/box') ?>" class="nav-link">
                  <i class="fas fa-angle-right nav-icon text-primary"></i>
                  <p>Box</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo url('/map') ?>" class="nav-link">
                  <i class="fas fa-angle-right nav-icon text-primary"></i>
                  <p>Map</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="<?php echo url('/input_dokumen') ?>" class="nav-link">
