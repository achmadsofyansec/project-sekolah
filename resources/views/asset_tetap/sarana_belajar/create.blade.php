              ...
              <div class="row">
                <div class="col-md-4 mt-1">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                          <p>1. isi <b>Sarana Belajar</b> Dengan Baik dan Benar.</p>
                ...
                <div class="col-md-8 mt-1">
                    <div class="card card-outline card-info">
                        <form action="{{route('sarana_belajar.store')}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Sarana Pembelajaran</label>
                                    <input type="text" name="sarana_pembelajaran" id="sarana_pembelajaran" class="form-control" required>
                                </div>
                                <div class="form-group">
