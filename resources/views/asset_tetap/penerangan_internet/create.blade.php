@extends('layouts.app')
@section('page', 'Peneranagan & Internet')
@section('content-app')
              ...
              <div class="row">
                <div class="col-md-4 mt-1">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                          <p>1. isi <b>Identitas Penerangan Dan Internet</b> Dengan Baik dan Benar.</p>
                          <p>2. Simpan Data Penerangan Dan Internet Dengan Cara Menekan <b>Tombol <button class="btn btn-success"><i class="fas fa-save"> Simpan</i></button></b>  Yang berada di bawah Form</p>
                        </div>
                ...
                <div class="col-md-8 mt-1">
                    <div class="card card-outline card-info">
                        <form action="{{route('penerangan_internet.store')}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card-body">
