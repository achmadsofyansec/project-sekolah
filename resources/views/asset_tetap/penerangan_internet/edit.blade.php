@extends('layouts.app')
@section('page', 'Edit Penerangan & Interner')
@section('content-app')
              ...
              <div class="row">
                <div class="col-md-4 mt-1">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                          <p>1. Ubah Isi <b>Penerangan & Internet</b> Dengan Baik dan Benar.</p>
                          <p>2. Simpan Data Penerangan & Internet Dengan Cara Menekan <b>Tombol <button class="btn btn-success"><i class="fas fa-save"> Simpan</i></button></b>  Yang berada di bawah Form</p>
                        </div>
                ...
                <div class="col-md-8 mt-1">
                    <div class="card card-outline card-info">
                        <form action="{{route('penerangan_internet.update', $data->id)}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <a href="{{route('penerangan_internet.index')}}" class="btn btn-danger"><i class="fas fa-undo"></i> Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>  
