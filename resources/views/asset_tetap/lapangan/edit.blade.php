              ...
              <div class="row">
                <div class="col-md-4 mt-1">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                          <p>1. Ubah Isi <b>Lapangan</b> Dengan Baik dan Benar.</p>
                          <p>2. Simpan Data Lapangan Dengan Cara Menekan <b>Tombol <button class="btn btn-success"><i class="fas fa-save"> Simpan</i></button></b>  Yang berada di bawah Form</p>
                        </div>
                ...
                <div class="col-md-8 mt-1">
                    <div class="card card-outline card-info">
                        <form action="{{route('lapangan.update', $data->id)}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                  <label class="col-sm-3 col-form-label">Kondisi</label>
                                    <div class="col-sm-12">
                                        <select type="text" class="form-control" id="kondisi" name="kondisi" value="" required />
                                ...
                                <a href="{{route('lapangan.index')}}" class="btn btn-danger"><i class="fas fa-undo"></i> Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>  
