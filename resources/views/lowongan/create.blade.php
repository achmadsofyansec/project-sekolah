@extends('layouts.app')
@section('page', 'Tambah Lowongan Kerja')
@section('content-app')
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?= url('/') ?>"><i class="fas fa-home-lg-alt"></i>
                                    Home</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('lowongan.index') }}">@yield('page')</a></li>
                        </ol>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    ...
                    <div class="animated fadeInLeft col-md-8">
                        <div class="card card-purple">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" role="form" action="{{ route('lowongan.store') }}"
                                ...
                                <div class="card-footer">
                                    ...
                                    <a class="btn btn-danger float-right" href="{{ route('lowongan.index') }}"><i
                                            class="fa fa-undo">
                                        </i> Kembali</a>
                                </div>
                                <!-- /.card-footer -->
