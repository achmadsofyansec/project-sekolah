                    ...
                    <div class="card card-outline card-info">
                        <form action="{{route('barang_sitaan.update',$data->id)}}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <input type="date" value="{{$tanggal}}" name="tgl_sita"  id="tgl_sita" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Siswa</label>
                                ...
                                <textarea name="barang_sitaan" id="barang_sitaan" cols="30" rows="8" placeholder="Keterangan" class="form-control" required>{{$data->keterangan_sita}}</textarea>
                                </div>
                            </div>
                            <div class="card-footer">
