@extends('layouts.app')
@section('page', 'Laporan Per Tahun')
@section('content-app')
        ...
        <div class="row-mb-2">
          <div class="col-md-12 mt-1">
            ...
            <div class="card card-orange card-outline">             
              <div class="card-body">
              <form action="{{route('laporan_tahunan')}}" method="GET">
                  <div class="row">
                    <div class="col-md-5">
                      <div class="form-group">
                        <input type="number" name="filter_awal" value="@if($req->filter_awal != null){{$req->filter_awal}}@endif" id="filter_awal" placeholder="YYYY" class="form-control"  min="1900">
                      </div>
                    </div>
                    <div class="col-md-5">
                      <div class="form-group">
                        <input type="number" name="filter_akhir" value="@if($req->filter_akhir != null){{$req->filter_akhir}}@endif" id="filter_akhir" placeholder="YYYY" class="form-control"  min="1900">
                      </div>
                    </div>
                      <div class="col-md-2">
                        <div class="form-group">
