              ...
              <div class="row">
                <div class="col-md-4 mt-1">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                          <p>1. isi <b>Tahun Ajaran</b> Dengan Baik dan Benar.</p>
                        ...
                        <form action="{{route('tahun_ajaran.store')}}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode_tahun_ajaran" id="kode_tahun_ajaran" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Tahun Ajaran</label>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <input type="number" name="tahun_ajaran_awal" id="tahun_ajaran_awal" class="form-control" required>
                                        </div>
                                        <div class="col-md-1 text-center">
                                            <h3>/</h3>
                                        </div>
                                        <div class="col-md-6">
                                            <input type="number" name="tahun_ajaran_akhir" id="tahun_ajaran_akhir" class="form-control" required>
                                        </div>
                                    </div>
