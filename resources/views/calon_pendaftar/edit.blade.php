  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row-mb-2">
            <div class="container-fluid">
                    <form action="{{ route('pendaftar.update',$data->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                        <div class="col-md-4">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="status_siswa" id="status_siswa" class="form-control">
                                            ...
                                            <option value="Diterima" @if ($data->status_siswa == "Diterima")
                                                {{'selected'}}
                                            @endif>Diterima</option>
                                            <option value="Ditolak" @if ($data->status_siswa == "Ditolak")
                                                {{'selected'}}
                                            @endif>Ditolak</option>
                                            <option value="Diverivikasi" @if ($data->status_siswa == "Diverivikasi")
                                                {{'selected'}}
                                            @endif>Diverivikasi</option>
                                        </select>
                                    </div>
