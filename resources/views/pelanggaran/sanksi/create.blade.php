@extends('layouts.app')
@section('page', 'Tambah Sanksi Pelanggaran')
@section('content-app')
              ...
              <div class="row">
                <div class="col-md-4 mt-1">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                          <p>1. isi <b>Sanksi Pelanggaran</b> Dengan Baik dan Benar.</p>
                        ...
                        <form action="{{route('sanksi.store')}}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode_sanksi" id="kode_sanksi" class="form-control" required>
                                </div>
                                <div class="form-group">
                                  <label>Poin Pelanggaran</label>
                                  <div class="row">
                                    <div class="col-md-5">
                                        <input type="number" name="dari_poin" id="dari_poin" class="form-control" required>
                                    </div>
                                    <div class="col-md-2 text-center">
                                      <p>sampai</p>
                                    </div>
                                    <div class="col-md-5">
                                      <input type="Number" name="sampai_poin" id="sampai_poin" class="form-control" required>
                                    </div>
                                  </div>
