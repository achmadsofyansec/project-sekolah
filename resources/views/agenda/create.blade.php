              ...
              <div class="row">
                <div class="col-md-4 mt-1">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                          <p>1. isi <b>Data Agenda</b> Dengan Baik dan Benar.</p>
                    ...
                    <div class="card card-outline card-info">
                        <form action="{{route('agenda.store')}}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Agenda</label>
                                    <input type="text" name="agenda" id="agenda" class="form-control" placeholder="Masukkan Agenda" required>
                                </div>
                                <div class="form-group">
                                    <label>Deskripsi Agenda</label>
                                    <textarea name="desc_agenda" id="desc_agenda" cols="30" rows="10" placeholder="Deskripsi Agenda" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="card-footer">
