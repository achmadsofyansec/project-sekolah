              ...
              <div class="row">
                <div class="col-md-4 mt-1">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                          <p>1.Ubah isi <b>Data Kehadiran</b> Dengan Baik dan Benar.</p>
                ...
                <div class="col-md-8 mt-1">
                    <div class="card card-outline card-info">
                        <form action="{{route('kehadiran.update',$data->id_absen)}}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Tanggal Izin</label>
                                <input type="date" value="{{$tanggal}}" name="tgl_kehadiran" id="tgl_kehadiran" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Siswa</label>
                                ...
                                <div class="form-group">
                                    <label>Alasan</label>
                                <textarea name="keterangan_kehadiran" id="keterangan_kehadiran" cols="30" rows="8" placeholder="Alasan" class="form-control" required>{{$data->alasan}}</textarea>
                                </div>
                            </div>
                            <div class="card-footer">
