                        ...
                        <form action="{{route('metode_bayar.store')}}" method="POST">
                            ...
                            <div class="card-body">
                              <div class="form-group">
                                  <label>Nama </label>
                                  <input type="text" class="form-control" name="nama_metode" id="nama_metode" required>
                              </div>
                              <div class="form-group">
                                  <label>Deskripsi</label>
                                  <textarea name="desc_metode" id="desc_metode" class="form-control" cols="30" rows="10" required></textarea>
                              </div>
                            </div>
                            <div class="card-footer">
