...
class CreatePpbdSiswasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if(!Schema::hasTable('ppbd_siswas')){
            Schema::create('ppbd_siswas', function (Blueprint $table) {
                $table->id();
                $table->string('nik');
                $table->string('nama');
                $table->string('nisn');
    ...
    {
        Schema::dropIfExists('ppbd_siswas');
    }
}
