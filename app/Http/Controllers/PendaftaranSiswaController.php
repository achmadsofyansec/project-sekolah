...
class PendaftaranSiswaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('calon_pendaftar.index', compact('pendaftar'));
    }
    ...
    {
        return view('calon_pendaftar.create');
    }
    ...
    {
        $data = ppbdSiswa::findOrFail($id);
        $img = config('app.url').'/assets/uploads/'.$data->foto_siswa;
        $data_ayah = ppdbOrtuSiswa::where([['id_siswa','=',$data->nik],['jns_ortu','=','ayah']])->get()->first();
        $data_ibu = ppdbOrtuSiswa::where([['id_siswa','=',$data->nik],['jns_ortu','=','ibu']])->get()->first();
        $data_wali = ppdbOrtuSiswa::where([['id_siswa','=',$data->nik],['jns_ortu','=','wali']])->get()->first();
        return view('calon_pendaftar.edit',compact(['data','img','data_ayah','data_wali','data_ibu']));
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       if($credential){
           ...
           $update = ppbdSiswa::findOrFail($id);
           $update->update($data);
           if($request->nik_ayah != null){
            $data_ayah = [
                'nik' => $request->nik_ayah,
            ...
            $update_ayah = ppdbOrtuSiswa::where([['id_siswa','=',$request->nik],['jns_ortu','=','ayah']])->get()->first();
            if($update_ayah != null){
        ...
        if($request->nik_ibu != null){
            ...
            $update_ibu = ppdbOrtuSiswa::where([['id_siswa','=',$request->nik],['jns_ortu','=','ibu']])->get()->first();
            if($update_ibu != null){
        ...
        if($request->nik_wali != null){
            ...
            $update_wali = ppdbOrtuSiswa::where([['id_siswa','=',$request->nik],['jns_ortu','=','wali']])->get()->first();
            if($update_wali != null){
    ...
    {
        $data = ppbdSiswa::findOrFail($id);
        $data_ortu = ppdbOrtuSiswa::where([['id_siswa','=',$data->nik]])->delete();
        $data->delete();
        if($data){
            return redirect()
            ->route('pendaftar.index')
            ->with([
                'success' => 'Data Pendaftar Has Been Deleted successfully'
            ]);
        }else{
            return redirect()
            ->back()
